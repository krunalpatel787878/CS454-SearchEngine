...
public class Indexer {
	...
	private Document getDocument(File file) throws IOException {
		...
		// index file contents
		Field contentField = new Field(IndexConstants.CONTENTS, new FileReader(
				file));
		// index file name
		Field fileNameField = new Field(IndexConstants.FILE_NAME,
				file.getName(), Field.Store.YES, Field.Index.NOT_ANALYZED);
		// index file path
		Field filePathField = new Field(IndexConstants.FILE_PATH,
